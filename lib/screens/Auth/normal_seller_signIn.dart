...
class NormalSellerSignInScreen extends StatefulWidget {
  Function toggleView;
  NormalSellerSignInScreen({Key? key, required this.toggleView})
      : super(key: key);

  @override
  State<NormalSellerSignInScreen> createState() =>
      _NormalSellerSignInScreenState();
}

class _NormalSellerSignInScreenState extends State<NormalSellerSignInScreen> {
  ...
  void signInSeller(BuildContext context) {
    authService.sellerSignIn(
      context: context,
